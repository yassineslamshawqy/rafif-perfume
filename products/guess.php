...
<body>
    <div class="img-container container image img-i i inline">
        <center>
            <img src="../img/guess.png" alt="" height="450">
        </center>
    </div>
    <div class="in-container inline in information container">
        <h2>guess outlet orignal perfume</h2>
        <h1 style="margin-left:30px;">550EGP</h1>
        ...
        <div class="buttons">
            <div class="size">
                <form action="../main.php" method="post">
                    <button name="th-ml">30ml</button>
                    <button name="nm-ml">100ml</button>
                </form>
            </div>
            <br>
            <br>
            <form action="../main.php" method="post">
                <button href="" class="btn" name="order-th">order now</button>
                <br>
    ...
    <style>
        *{
        ...
        document.getElementById('tt').onclick = function(){
            ...
            window.alert("the price is 250EGP (offers)");
        }
    </script>
</body>
</html>