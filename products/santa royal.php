...
<body>
    <div class="img-container container image img-i i inline">
        <center>
            <img src="../img/santa royal.png" alt="" height="450">
        </center>
    </div>
    <div class="in-container inline in information container">
        <h2>santaL royal outlet orignal perfume</h2>
        ...
        <div class="buttons">
            <div class="size">
                <form action="../main.php" method="post">
                    <button name="tw-ml">125ml</button>
                </form>
            </div>
            <br>
            <br>
            <form action="../main.php" method="post">
                <button href="" class="btn" name="order-sa">order now</button>
                <br>
