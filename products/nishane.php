...
<body>
    <div class="img-container container image img-i i inline">
        <center>
            <img src="../img/nishane-removebg-preview.png" alt="" height="450">
        </center>
    </div>
    <div class="in-container inline in information container">
        <h2>nishane outlet orignal perfume</h2>
        <h1 style="margin-left:30px;">850EGP</h1>
        ...
        <div class="buttons">
            <div class="size">
                <form action="../main.php" method="post">
                    <button name="nh-ml">100ml</button>
                </form>
            </div>
            <br>
            <br>
            <form action="../main.php" method="post">
                <button href="" class="btn" name="order-nh">order now</button>
                <br>
