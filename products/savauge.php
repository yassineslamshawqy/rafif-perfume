...
<meta charset="UTF-8">
    ...
    <meta content="savauge" name="description">
...
<body>
    <div class="img-container container image img-i i inline">
        <center>
            <img src="../img/sauvage.png" alt="" height="450">
        </center>
    </div>
    <div class="in-container inline in information container">
        <h2>sauvage outlet orignal perfume</h2>
        <h1 style="margin-left:30px;">700EGP</h1>
        ...
        <div class="buttons">
            <div class="size">
                <form action="../main.php" method="post">
                    <button name="h-ml">100ml</button>
                </form>
            </div>
            <br>
            <br>
            <form action="../main.php" method="post">
                <button href="" class="btn" name="order-s">order now</button>
                <br>
