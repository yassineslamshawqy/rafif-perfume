...
<body>
    <div class="img-container container image img-i i inline">
        <center>
            <img src="../img/versace.png" alt="" height="450">
        </center>
    </div>
    <div class="in-container inline in information container">
        <h2>versace eros outlet orignal perfume</h2>
        <h1 style="margin-left:30px;">870EGP</h1>
        ...
        <div class="buttons">
            <div class="size">
                <form action="../main.php" method="post">
                    <button name="ver-ml">100ml</button>
                    <button name="ver-mt">50ml</button>
                </form>
            </div>
            <br>
            <br>
            <form action="../main.php" method="post">
                <button href="" class="btn" name="order-ver">order now</button>
                <br>
